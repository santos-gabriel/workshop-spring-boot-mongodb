...
import br.com.gabrieldossantos.workshopmongo.resources.util.URL;
...
public class PostResource {
	...
	public ResponseEntity<List<Post>> findByTitle(@RequestParam(value = "text", defaultValue = "") String text) {
		...
		return ResponseEntity.ok().body(serv.findByTitle(text));
	}
	...
	public ResponseEntity<List<Post>> fullSearch(
		...
		return ResponseEntity.ok().body(serv.fullSearch(text, min, max));
	}
